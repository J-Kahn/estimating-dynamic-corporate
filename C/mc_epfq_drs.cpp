...
int main(int argc, char **argv){
  ...
  int thr_num = 14;
	...
	matrix moms = readcsv("../Results/MC/trial_data_rr_drs_quad.csv", 100, 6 * 3);
	matrix vmoms = readcsv("../Results/MC/trial_data_rr_drs_wquad.csv", 100, 6 * 6 * 3 * 3);
...
string res, filename, filername, resr;
	...
	filername = "../Results/MC/Trials/summary_quad_drs_rr10" + resr;
