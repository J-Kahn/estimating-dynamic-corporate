...
int main(int argc, char **argv){
  ...
  int thr_num = 14;
	...
	matrix moms = readcsv("../Results/MC/trial_data_rr_mis_mom.csv", 5000, 8);
	matrix vmoms = readcsv("../Results/MC/trial_data_rr_mis_wmom.csv", 5000, 8*8);
...
string res, filename, filername, resr;
	...
	filername = "../Results/MC/Trials/summary_mom_rr_mis1" + resr;
