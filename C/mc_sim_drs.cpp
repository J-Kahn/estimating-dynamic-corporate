...
int main(int argc, char **argv){
    ...
    matrix v(n);
    string type = "quad_drs_toni_rr3";
    string prefix = "../Results/MC/trial_data_rr_drs_";
    string file = "../Results/MC/trial_data_rr_drs_moments.csv";
    ...
    matrix randus(nobsper * nfirms + 100 * nfirms + nfirms * 3, 1);
    int seedn = 1158;
    srand(seedn);
    randus.randu();
    ...
    data dat1 = data(100, 100 + nobsper, nfirms, 60, 1);
