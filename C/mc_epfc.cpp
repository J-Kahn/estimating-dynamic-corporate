...
int main(int argc, char **argv){
  ...
  int thr_num  = 14;
	...
	matrix moms = readcsv("../Results/MC/trial_data_rr_cube.csv", 1000, 10 * 3);
	matrix vmoms = readcsv("../Results/MC/trial_data_rr_wcube.csv", 1000, 10 * 10 * 3 * 3);
...
string res, filename, filername, resr;
	...
	filername = "../Results/MC/Trials/summary_cube_rr10" + resr;
