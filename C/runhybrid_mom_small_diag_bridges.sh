...
cp /home/rkahn/estimating-dynamic-corporate/C/monte_mom_small_diag /pylon5/se4s82p/rkahn/estimating-dynamic-corporate/C

#run MPI program
mpirun -print-rank-map -n $SLURM_NTASKS -genv \
OMP_NUM_THREADS=$SLURM_CPUS_PER_TASK -genv I_MPI_PIN_DOMAIN=omp ./monte_mom_small_diag
