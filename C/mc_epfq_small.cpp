...
int main(int argc, char **argv){
  ...
  int thr_num = 14;
	...
	matrix vmoms = readcsv("../Results/MC/trial_data_rr_small_wquad.csv", 5000, 6 * 6 * 3 * 3);
...
string res, filename, filername, resr;
	...
	filername = "../Results/MC/Trials/summary_quad_rr10_small" + resr;
