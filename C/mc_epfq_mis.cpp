...
int main(int argc, char **argv){
  ...
  int thr_num  = 14;
	...
	matrix moms = readcsv("../Results/MC/trial_data_rr_mis_quad.csv", 5000, 6 * 3);
	matrix vmoms = readcsv("../Results/MC/trial_data_rr_mis_wquad.csv", 5000, 6 * 6 * 3 * 3);
...
string res, filename, filername, resr;
	...
	filername = "../Results/MC/Trials/summary_quad_rr10_mis1" + resr;
